...
<html>
    <head>
        ...
        <!-- Bootstrap -->
        <link href="./resources/css/main/bootstrap.css" rel="stylesheet" type="text/css" />
        <!-- Animate.css -->
        <link href="./resources/css/main/animate.css" rel="stylesheet" type="text/css" />
        <!-- Font Awesome iconic font -->
        <link href="./resources/css/main/fontawesome-all.css" rel="stylesheet" type="text/css" />
        <!-- Magnific Popup -->
        <link href="./resources/css/main/magnific-popup.css" rel="stylesheet" type="text/css" />
        <!-- Slick carousel -->
        <link href="./resources/css/main/slick.css" rel="stylesheet" type="text/css" />
        <!-- Fonts -->
        <link href='https://fonts.googleapis.com/css?family=Oswald:300,400,500,700' rel='stylesheet' type='text/css'>
        <link href='https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700' rel='stylesheet' type='text/css'>
        <!-- Theme styles -->
        <link href="./resources/css/main/dot-icons.css" rel="stylesheet" type="text/css">
        <link href="./resources/css/main/theme.css" rel="stylesheet" type="text/css">
    </head>
    <body class="body">
                    ...
                    <a class="navbar-brand" href="./">
                        <span class="logo-element">
                            <span class="logo-tape">
                                <span class="svg-content svg-fill-theme" data-svg="./resources/images/main/svg/logo-part.svg"></span>
                            </span>
                            <span class="logo-text text-uppercase">
                                <span>E</span>EzenFlix</span>
                        </span>
                    </a>
        ...
        <!-- jQuery library -->
        <script src="./resources/js/main/jquery-3.3.1.js"></script>
        <!-- Bootstrap -->
        <script src="./resources/js/main/bootstrap.js"></script>
        <!-- Paralax.js -->
        <script src="./resources/js/main/parallax.js"></script>
        <!-- Waypoints -->
        <script src="./resources/js/main/jquery.waypoints.min.js"></script>
        <!-- Slick carousel -->
        <script src="./resources/js/main/slick.min.js"></script>
        <!-- Magnific Popup -->
        <script src="./resources/js/main/jquery.magnific-popup.min.js"></script>
